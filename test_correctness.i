# 0 "test_correctness.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "test_correctness.c"
...
int test_pke_correctness()
{
 ...
 for(j=0;j<loop;j++)
 {
  ...
  for(i=0;i<10000;i++)
  {
   ...
   {
    error_num++;
    error_bit=error_bit_num(k1,k2,32);
    sum+=error_bit;
    if(error_bit>0)
    {
